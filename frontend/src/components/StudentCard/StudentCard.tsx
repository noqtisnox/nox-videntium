...
const StudentCard: React.FC<Props> = ({ id, submissionStatus }) => {
  ...
  return (
    <div className='relative inline-block m-4 border-2 rounded-2xl p-2 pr-8 cursor-default hover:-translate-y-2 hover:transition hover:ease-in-out'>
      <span className='flex flex-row items-center'>
        <img 
          ...
          alt='Student PFP'
        />
        <p className='text-2xl m-4'>{placeholderData.name}</p>  
      </span>
